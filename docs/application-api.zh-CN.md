...
> [English](application-api.md) | 简体中文 · [ADR-0005](adr/0005-goal-evidence-completion-contract.md) · [ADR-0006](adr/0006-desktop-consumer-observation-boundary.md) · [ADR-0008](adr/0008-current-session-schema-discovery.md) · [ADR-0010](adr/0010-provider-model-configuration-phase-1.md)
...
- Session 在可变 application metadata 中保存 Configured Model id；`session.select_models()` 即使在 Turn 运行中调用也只影响下一 Turn，当前 Turn 的 agent/judge 绑定保持不变；
